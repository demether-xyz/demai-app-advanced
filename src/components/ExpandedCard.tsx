    ...
    portfolio: (
      <div className="space-y-6">
        <div className="grid grid-cols-3 gap-3">
          <div className="rounded-lg bg-slate-800/50 p-4">
            <div className="mb-1 text-xl font-medium text-slate-200">$124,567</div>
            <div className="text-sm text-slate-400">Total Value</div>
            <div className="mt-1 text-xs text-emerald-400">↗ +$8,921 (7d)</div>
          </div>
          <div className="rounded-lg bg-slate-800/50 p-4">
            <div className="mb-1 text-xl font-medium text-emerald-400">16.8%</div>
            <div className="text-sm text-slate-400">Avg APY</div>
            <div className="mt-1 text-xs text-emerald-300">Weighted Average</div>
          </div>
          <div className="rounded-lg bg-slate-800/50 p-4">
            <div className="mb-1 text-xl font-medium text-blue-400">$2,847</div>
            <div className="text-sm text-slate-400">Daily Yield</div>
            <div className="mt-1 text-xs text-blue-300">$86,210 (30d)</div>
          </div>
        </div>
        ...
        <div className="space-y-3">
          ...
          <div className="grid grid-cols-2 gap-3 text-sm">
            ...
            <div className="rounded-lg bg-slate-800/30 p-3">
              ...
              <div className="font-medium text-red-400">-12.4%</div>
