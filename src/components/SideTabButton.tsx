...
const SideTabButton: React.FC<SideTabButtonProps> = ({
  ...
  return (
    <button onClick={onClick} className={`${baseClasses} ${buttonClasses}`} style={style}>
      <div className="text-xs font-medium tracking-wider whitespace-nowrap" style={{ transform: `rotate(${rotationDegrees}deg)` }}>
